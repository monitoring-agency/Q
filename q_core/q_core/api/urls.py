...
urlpatterns = [
    ...
    path("observables", ObservableView.as_view()),
    path("observables/<str:sid>", ObservableView.as_view()),
    path("observablestemplates", ObservableTemplateView.as_view()),
    path("observablestemplates/<str:sid>", ObservableTemplateView.as_view()),
