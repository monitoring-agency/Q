    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('core_secret', models.CharField(default='', max_length=255)),
                ('core_address', models.CharField(default='', max_length=255)),
                ('core_port', models.PositiveIntegerField(default=4443)),
