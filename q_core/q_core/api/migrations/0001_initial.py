# Generated by Django 4.0.1 on 2022-02-15 20:24
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('linked_contacts', models.ManyToManyField(blank=True, to='api.Contact')),
                ('metric_templates', models.ManyToManyField(blank=True, to='api.OrderedListItem')),
                ('notification_period', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='notification_mt', to='api.timeperiod')),
                ...
                ('scheduling_period', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='scheduling_mt', to='api.timeperiod')),
            ],
        ),
        migrations.CreateModel(
            name='Metric',
